Feature: Add new user
  ...
  Scenario Outline: ID001 register_new_user_success
  ...
  Scenario Outline: ID001 reject_duplicate_username_invalid_password
  ...
  Scenario Outline: ID001 reject_duplicate_email
